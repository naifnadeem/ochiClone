function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 p-20 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between font-[myfont]">
      ...
      <div className="w-1/2 ">
        <h1 className="text-[8vw] uppercase font-[myfont] leading-none -mb-10">Presentations</h1>
        <div className="dets font-[navbarfont] mt-10">
